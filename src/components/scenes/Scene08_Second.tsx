...
export default function Scene08_Second() {
  ...
  return (
    <div className="w-screen h-screen bg-black">
      ...
      >
        <h1 className="text-5xl font-thin tracking-wider">23:59:59 — ostatnia sekunda roku.</h1>
        <p className="text-gray-300 italic mt-3">23:59:59 — the last second of the year.</p>
      </motion.div>
    </div>
  );
}
