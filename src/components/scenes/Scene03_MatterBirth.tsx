...
export default function Scene03_MatterBirth() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-3xl font-light tracking-widest">Z pyłu powstają wspomnienia.</h1>
        <p className="text-gray-400 italic mt-2 text-sm">From dust, memories form.</p>
      </motion.div>
    </div>
  );
}
