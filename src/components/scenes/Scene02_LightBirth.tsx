...
function AnimatedLight({ mouse }: { mouse: { x: number; y: number } }) {
  ...
  return <pointLight ref={lightRef} intensity={3} color="#8AB4FF" distance={20} />;
}
